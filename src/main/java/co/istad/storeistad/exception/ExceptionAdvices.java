...
public class ExceptionAdvices {
    ...
    public ResponseEntity<StructureRS> handleNoResourceFound(NoResourceFoundException ex) {
        ...
        if (path != null && path.contains("favicon.ico")) {
            ...
            StructureRS body = new StructureRS(HttpStatus.NOT_FOUND, "Favicon not found (ignored).");
            body.setData(null);
        ...
        StructureRS body = new StructureRS(HttpStatus.BAD_REQUEST, "Requested static resource not found.");
        body.setData(path);
